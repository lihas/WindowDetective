...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_EditPropertyPage_t, stringdata) + ofs \
...
const QMetaObject EditPropertyPage::staticMetaObject = {
    { &AbstractPropertyPage::staticMetaObject, qt_meta_stringdata_EditPropertyPage.data,
      qt_meta_data_EditPropertyPage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EditPropertyPage.stringdata))
        return static_cast<void*>(const_cast< EditPropertyPage*>(this));
