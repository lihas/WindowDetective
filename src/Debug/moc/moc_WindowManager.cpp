...
QT_MOC_LITERAL(1, 14, 11), // "windowAdded"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7), // "Window*"
QT_MOC_LITERAL(4, 35, 6), // "window"
QT_MOC_LITERAL(5, 42, 13), // "windowRemoved"
QT_MOC_LITERAL(6, 56, 12), // "processAdded"
QT_MOC_LITERAL(7, 69, 8), // "Process*"
QT_MOC_LITERAL(8, 78, 7), // "process"
QT_MOC_LITERAL(9, 86, 14) // "processRemoved"

    },
    "WindowManager\0windowAdded\0\0Window*\0"
    "window\0windowRemoved\0processAdded\0"
    "Process*\0process\0processRemoved"
};
...
void WindowManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (WindowManager::*)(Window * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WindowManager::windowAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (WindowManager::*)(Window * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WindowManager::windowRemoved)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (WindowManager::*)(Process * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WindowManager::processAdded)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (WindowManager::*)(Process * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WindowManager::processRemoved)) {
                *result = 3;
                return;
            }
        }
