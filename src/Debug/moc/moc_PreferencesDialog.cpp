...
QT_MOC_LITERAL(5, 75, 24),
QT_MOC_LITERAL(6, 100, 24),
QT_MOC_LITERAL(7, 125, 27),
QT_MOC_LITERAL(8, 153, 25),
QT_MOC_LITERAL(9, 179, 15),
QT_MOC_LITERAL(10, 195, 14),
QT_MOC_LITERAL(11, 210, 14),
...
void PreferencesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PreferencesDialog::highlightWindowChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (PreferencesDialog::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PreferencesDialog::stayOnTopChanged)) {
                *result = 1;
            }
        }
    }
