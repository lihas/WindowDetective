...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AbstractPropertyPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AbstractPropertyPage_t qt_meta_stringdata_AbstractPropertyPage = {
    {
QT_MOC_LITERAL(0, 0, 20), // "AbstractPropertyPage"
QT_MOC_LITERAL(1, 21, 13), // "evenRowColour"
QT_MOC_LITERAL(2, 35, 12) // "oddRowColour"
...
void AbstractPropertyPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<AbstractPropertyPage *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QColor*>(_v) = _t->getEvenRowColour(); break;
        case 1: *reinterpret_cast< QColor*>(_v) = _t->getOddRowColour(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setEvenRowColour(*reinterpret_cast< QColor*>(_v)); break;
        case 1: _t->setOddRowColour(*reinterpret_cast< QColor*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject AbstractPropertyPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_AbstractPropertyPage.data,
    qt_meta_data_AbstractPropertyPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AbstractPropertyPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AbstractPropertyPage.stringdata0))
