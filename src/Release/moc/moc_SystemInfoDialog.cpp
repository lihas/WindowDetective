...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SystemInfoDialog_t, stringdata) + ofs \
...
const QMetaObject SystemInfoDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SystemInfoDialog.data,
      qt_meta_data_SystemInfoDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SystemInfoDialog.stringdata))
        return static_cast<void*>(const_cast< SystemInfoDialog*>(this));
