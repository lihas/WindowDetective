...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ResizableDockContainer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ResizableDockContainer_t qt_meta_stringdata_ResizableDockContainer = {
    {
QT_MOC_LITERAL(0, 0, 22) // "ResizableDockContainer"
...
QT_INIT_METAOBJECT const QMetaObject ResizableDockContainer::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ResizableDockContainer.data,
    qt_meta_data_ResizableDockContainer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ResizableDockContainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ResizableDockContainer.stringdata0))
